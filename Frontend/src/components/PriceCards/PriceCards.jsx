        ...
        {data &&
          data?.map((item, idx) => (
            ...
            >
              ...
              <div className={`text-[22px] bg-gradient-to-r ${type != 'Dating' ? 'from-[#02AFDC] to-[#2563EB]' : 'from-[#e73e71] to-[#af1040] '}  inline-block text-transparent bg-clip-text font-bold`}>{item?.title}</div>
